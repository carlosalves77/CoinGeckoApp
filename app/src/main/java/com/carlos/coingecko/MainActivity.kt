...
import com.carlos.coingecko.databinding.ActivityMainBinding
import com.carlos.coingecko.domain.model.Coin
import com.carlos.coingecko.presentation.CoinList.CoinAdapter
import com.carlos.coingecko.presentation.CoinList.CoinListViewModel
            ...
            coinListViewModel._coinListValue.collectLatest { coinListValue ->
                if (coinListValue.isLoading) {
                    ...
                    if (coinListValue.error.isNotBlank()) {
                        ...
                        Toast.makeText(this@MainActivity, coinListValue.error, Toast.LENGTH_LONG)
                            .show()
                    } else {
                        binding.progressBar.visibility = View.GONE
    ...
    private fun setUpTheRecyclerView() {
        ...
        binding.coinRecyclerView.addItemDecoration(
            DividerItemDecoration(
                ...
                (GridLayoutManager(this, 2).orientation)
            )
        )
    }
